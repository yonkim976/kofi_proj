...
import pandas as pd
from utils import get_company_info, get_stock_info, get_stock_close_price
...
if search_clicked and corp_names and crtfc_key:
    ...
    for corp_name in corp_name_list:
        try:
            ...
            total_issued_stocks = get_stock_info(crtfc_key, corp_code)
            ...
            company_info["종가"] = close_price if close_price else "정보 없음"
